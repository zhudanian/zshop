...
<head>
    ...
    <script>
        $(function(){
            ...
            $('#pagination').bootstrapPaginator({
                ...
                pageUrl: function (type, page, current) {
                    return '${pageContext.request.contextPath}/backend/productType/findAllByPage?pageNum='+page;
                },
            ...
            function(data){
                ...
                if(data.status==1){
                    ...
                    layer.msg(data.message,{
                        ...
                        //返回当前页
                        window.location.href='${pageContext.request.contextPath}/backend/productType/findAllByPage?pageNum='+${data.pageNum};
                    });
                }
                else{
                    layer.msg(data.message,{
        ...
        function modifyName(){
            $.ajax({
                type:'post',
                url:'${pageContext.request.contextPath}/backend/productType/modify',
        ...
        function deleteProductType(){
            $.post('${pageContext.request.contextPath}/backend/productType/deleteById',
                    {'id':$('#productTypeId').val()},function(result){
                        if(result.status==1){
                            layer.msg(result.message,{
                                time:2000,
                                skin:'successMsg'
                ...
                <tr>
                    ...
                    <td class="text-center">
                        ...
                        <input type="button" class="btn btn-warning btn-sm doProTypeDelete" value="删除"
                               onclick="showDelModal(${productType.id})">
...
<div class="modal fade" tabindex="-1" id="delProductType">
    ...
    <div class="modal-dialog modal-sm">
        ...
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button class="btn btn-warning updateProType" onclick="deleteProductType()">确认</button>
                <button class="btn btn-primary cancel" data-dismiss="modal">取消</button>
            </div>
        </div>
    </div>
